...
class TiledImageMaskDatasetGenerator:
  ...
  def create_mask_files(self, mask_file, index):
    ...
    if self.augmentation:
        ...
        self.augment(resized, basename, self.output_masks_dir, border=(0, 0, 0), mask=True)
  ...
  def create_image_files(self, image_file, index):
    ...
    if self.augmentation:
        #    augment(self, image, basename, output_dir, border=(0, 0, 0), mask=False):
        self.augment(resized, basename, self.output_images_dir, border=(0, 0, 0), mask=False)
...
if __name__ == "__main__":
  try:
    input_images_dir = "./HRF/images/"
    input_masks_dir  = "./HRF/manual1/"

    output_images_dir = "./Augmented-Tiled-HRF-master/images/"
    output_masks_dir  = "./Augmented-Tiled-HRF-master/masks/"
